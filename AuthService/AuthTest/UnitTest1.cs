...
namespace AuthTest
{
    public class Tests
    {
        ...
        public void Setup()
        {
            user = new List<User>()
            {
                new User{User_Id=1,User_Name="abc",Password="abc123"}
        ...
        public void LoginTest()
        {
            ...
            var auth = controller.Login(new User { User_Id = 1, User_Name = "abc", Password = "abc123" }) as OkObjectResult;
        ...
        public void LoginTestFail()
        {
            ...
            config.Setup(p => p["Jwt:Key"]).Returns("ThisismySecretKey");
            var controller = new AuthController(usercontextmock.Object, config.Object);
            var auth = controller.Login(new User { User_Id = 3, User_Name = "xyz", Password = "xyz123" }) as OkObjectResult;
